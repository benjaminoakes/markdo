...
/* Generated by Opal 0.10.2 */
Opal.modules["markdo/models/task_attribute"] = function(Opal) {
  var self = Opal.top, $scope = Opal, nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $module = Opal.module, $klass = Opal.klass;

  Opal.add_stubs(['$require', '$attr_reader', '$parse', '$to_s', '$value', '$==', '$key']);
  self.$require("date");
  return (function($base) {
    var $Markdo, self = $Markdo = $module($base, 'Markdo');

    var def = self.$$proto, $scope = self.$$scope;

    (function($base, $super) {
      function $TaskAttribute(){};
      var self = $TaskAttribute = $klass($base, $super, 'TaskAttribute', $TaskAttribute);

      var def = self.$$proto, $scope = self.$$scope, TMP_1, TMP_2, TMP_3;

      self.$attr_reader("key", "value");

      Opal.defn(self, '$initialize', TMP_1 = function ːinitialize(key, value) {
        var self = this;
      ...
      Opal.defn(self, '$date_value', TMP_2 = function ːdate_value() {
        var self = this;

        try {
          return $scope.get('Date').$parse(self.$value().$to_s())
        } catch ($err) {
          if (Opal.rescue($err, [$scope.get('ArgumentError')])) {
            try {
              return nil
      ...
      return (Opal.defn(self, '$==', TMP_3 = function(other) {
        var $a, self = this;

        return (($a = other.$key()['$=='](self.$key())) ? other.$value()['$=='](self.$value()) : other.$key()['$=='](self.$key()));
      }, TMP_3.$$arity = 1), nil) && '==';
    })($scope.base, null)
  })($scope.base);
};
...
/* Generated by Opal 0.10.2 */
Opal.modules["markdo/models/task"] = function(Opal) {
  var self = Opal.top, $scope = Opal, nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $module = Opal.module, $klass = Opal.klass;

  Opal.add_stubs(['$require', '$attr_reader', '$==', '$line', '$!', '$match', '$sub', '$keys', '$attributes', '$map', '$downcase', '$[]', '$new', '$scan']);
  self.$require("markdo/models/task_attribute");
  return (function($base) {
    var $Markdo, self = $Markdo = $module($base, 'Markdo');
    ...
    (function($base, $super) {
      ...
      Opal.defn(self, '$initialize', TMP_1 = function ːinitialize(line) {
        var self = this;
      ...
      Opal.defn(self, '$complete?', TMP_3 = function() {
        var self = this;

        return self.$line().$match(/\s*[-*] \[x\]\s+/)['$!']()['$!']();
      }, TMP_3.$$arity = 0);

      Opal.defn(self, '$body', TMP_4 = function ːbody() {
        var self = this;

        return self.$line().$sub(/\s*[-*] \[.\]\s+/, "").$sub(/\s*$/, "");
      }, TMP_4.$$arity = 0);

      Opal.defn(self, '$tags', TMP_5 = function ːtags() {
        var self = this;

        return self.$attributes().$keys();
      }, TMP_5.$$arity = 0);

      return (Opal.defn(self, '$attributes', TMP_7 = function ːattributes() {
        var $a, $b, TMP_6, self = this, a = nil;

        a = ($a = ($b = self.$line().$scan(/\s@\S+/)).$map, $a.$$p = (TMP_6 = function(s){var self = TMP_6.$$s || this, match_data = nil, key = nil, value = nil;
if (s == null) s = nil;
        match_data = s.$match(/@([a-zA-Z0-9]+)(\((.+)\))?/);
          if (match_data !== false && match_data !== nil && match_data != null) {
            key = match_data['$[]'](1).$downcase();
            value = match_data['$[]'](3);
            return [key, $scope.get('TaskAttribute').$new(key, value)];
            } else {
            return nil
          };}, TMP_6.$$s = self, TMP_6.$$arity = 1, TMP_6), $a).call($b);
        return $scope.get('Hash')['$[]'](a);
      }, TMP_7.$$arity = 0), nil) && 'attributes';
    })($scope.base, null)
  })($scope.base);
};

/* Generated by Opal 0.10.2 */
Opal.modules["markdo/models/task_collection"] = function(Opal) {
  function $rb_ge(lhs, rhs) {
    return (typeof(lhs) === 'number' && typeof(rhs) === 'number') ? lhs >= rhs : lhs['$>='](rhs);
  }
  function $rb_le(lhs, rhs) {
  ...
  return (function($base) {
    ...
    (function($base, $super) {
      ...
      Opal.defn(self, '$all', TMP_2 = function ːall() {
        var self = this;
...
(function(Opal) {
  ...
  Opal.add_stubs(['$require']);
  self.$require("opal");
  return self.$require("markdo/models/task_collection");
})(Opal);
